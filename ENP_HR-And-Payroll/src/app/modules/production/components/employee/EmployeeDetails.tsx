...
const EmplyeeDetails= () =>{
  ...
  const {data:alPaygroups} = useQuery('paygroups',()=> fetchDocument(`/${tenantId}`), {cacheTime:5000})
  const {data:allUnits} = useQuery('units',()=> fetchDocument(`Units/${tenantId}`), {cacheTime:5000})
  ...
  return (
    ...
    >
      ...
      <div className='col-4 mb-7'>
            {
              ...
              <img style={{borderRadius:"10px", marginBottom:"20px"}} src={`https://enp.sipconsult.net/hrwebapi/uploads/employee/${tempData?.imageUrl}`} width={150} height={150}></img>:
              <img style={{borderRadius:"10px",marginBottom:"20px"}} src={`https://enp.sipconsult.net/hrwebapi/uploads/employee/ahercode1.jpg`} width={150} height={150}></img>
            }
      ...
      <div className='row mb-5'>
        ...
        <div className='col-3 mb-5'>
          <h5 style={{ color:"GrayText"}} >Situation Matrimoniale:
            <span style={{ color:"black"}}> {tempData?.maritalStatus===null?" NULL":tempData?.maritalStatus }</span>
          </h5>
        </div>
        <div className='col-3 mb-5'>
          <h5 style={{ color:"GrayText"}} >
            Nationalité: <span style={{ color:"black"}}>{tempData?.nationality===null?" NULL":nation}</span>
          </h5>
        </div>
        <div className='col-3 mb-5'>
          <h5 style={{ color:"GrayText"}} >
      ...
      <div className='row mb-5'>
        ...
        <br />
        <div className='col-3 mb-5'>
            <h5  style={{ color:"GrayText"}}>Numero Téléphone: <span style={{ color:"black"}}>{tempData?.phone===null?" NULL":tempData?.phone}</span></h5>
        </div>
        <div className='col-3 mb-5'>
            <h5  style={{ color:"GrayText"}}>Contact Alternative: <span style={{ color:"black"}}>{tempData?.alternativePhone===null?" NULL":tempData?.alternativePhone}</span></h5>
        </div>
        <div className='col-3 mb-5'>
      ...
      <div className='row mb-5'>
        ...
        <div className='col-3 mb-5'>
            <h5  style={{ color:"GrayText"}}> Date de prise de fonction: <span style={{ color:"black"}}>{tempData?.employmentDate===null?" NULL":tempData?.employmentDate}</span></h5>
        </div>
      </div>
